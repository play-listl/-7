document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Mozambique': [20, 12, 8, 6, 4, 3, 2, 0],
        'Kazakhstan': [16, 16, 11, 7, 5, 4, 2, 1],
        'Equatorial Guinea': [12, 12, 14, 9, 7, 5, 3, 2],
        'Switzerland': [10, 10, 11, 12, 8, 6, 4, 4],
        'Luxembourg': [8, 8, 8, 9, 11, 8, 5, 5],
        'Philippines': [6, 6, 7, 7, 8, 10, 7, 5],
        'Bangladesh': [5, 5, 5, 6, 7, 9, 9, 7],
        'Mauritius': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Mozambique', year: '34 points' },
        { city: 'Kazakhstan', year: '30 points' },
        { city: 'Equatorial Guinea', year: '26 points' },
        { city: 'Switzerland', year: '24 points' },
        { city: 'Luxembourg', year: '22 points' },
        { city: 'Philippines', year: '20 points' },
        { city: 'Bangladesh', year: '17 points' },
        { city: 'Mauritius', year: '11 points' }
    ];
